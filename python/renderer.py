...
class Renderer:
    ...
    def render_page3(self) -> bytes:
        ...
        # Show the config URL in both LAN and AP modes.
        # AP Wi-Fi QR codes are larger than LAN URL QR codes, so keep this to
        # one line to avoid colliding with the footer on the 122px-tall canvas.
        if lan_ip:
